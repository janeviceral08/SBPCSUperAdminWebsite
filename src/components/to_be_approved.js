...
export default class To_Be_Approved extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
       ...
       axios.post('https://superadmins.herokuapp.com/admin/approval')
  ...
  //  console.log('expired: ', moment(expiration).unix())
    ...
    if(expiration === ''){
      ...
      axios.post('https://superadmins.herokuapp.com/admin/approved_account', approved)
   ...
   handleShow = (info) => {
    ...
    handleShowBlocked = (info) => {
        ...
        axios.post('https://superadmins.herokuapp.com/admin/blocked_account', approved)
        .then(res =>window.location.reload())  
        ...
        handleShowPass = (info) => {
            ...
            axios.post('https://superadmins.herokuapp.com/admin/pass_account', approved)
         .then(res =>window.location.reload()) 
        };
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <Link to="/To_Be_Approved" class="nav-link active"><i class="fa fa-fw fa-rocket"></i>To be Approved</Link>
                            </li>
                            <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">To Be Approve</h2>
                            <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Datas</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">To Be Approve</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            <td><a onClick={()=>this.handleShow(info)}>Approved</a> | <a onClick={()=>this.handleShowPass(info)}>Pass</a>  | <a onClick={()=>this.handleShowBlocked(info)}>Blocked</a></td>
                                        </tr>
                                            ) }
