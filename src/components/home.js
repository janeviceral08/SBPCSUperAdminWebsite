...
export default class Home extends Component {
  ...
  componentDidMount() {
   /* axios.get('https://superadmins.herokuapp.com/exercises/')
      .then(response => {
      ...
      */
    /*  axios.post('https://superadmins.herokuapp.com/admin/approval', exercise)
                ...
                <div class="container-fluid dashboard-content">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h3 class="mb-2"> Hotel Finder </h3>
                                <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                                            <li class="breadcrumb-item active" aria-current="page"> Hotel Finder</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                          ...
                          <Link to={`/create/${info._partition}`} >
                            <div class="card-body">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div class="pl-xl-3">
                                                <div class="m-b-0">
                                                    <div class="user-avatar-name d-inline-block">
                                                        <h2 class="font-24 m-b-10">{info.hot_name}</h2>
                                                    </div>
                                                   
                                                </div>
                                                <div class="user-avatar-address">
                                                    <p class="mb-2"><i class="fa fa-map-marker-alt mr-2  text-primary"></i>{info.hot_address} <span class="m-l-10">{info.hot_address}</span>
                                                    </p>
                                                    <div class="mt-3">
                                                    <p class="mb-2"><i class="fas fa-envelope mr-2  text-primary"></i>{info.name} <span class="m-l-20"><i class="fas fa-mobile-alt mr-2  text-primary"></i>{info.mobile}</span>
                                                    </p>    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="float-xl-right float-none mt-xl-0 mt-4">
                                                <a href="#" class="btn btn-secondary">{moment(info.expiration * 1000).format('MMM D, YYYY h:mm a')}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    <div class="user-avatar-name d-inline-block" style={{marginLeft: '20px'}}>
                                                        <h4 class="font-15 m-b-10">Hotel Information</h4>
                                                    </div>
                                                   
                                             
                                <div class="border-top user-social-box">
                                    <div class="user-social-media d-xl-inline-block "><span class="mr-2 twitter-color"> <i class="fas fa-phone-square"></i></span><span>{info.hotel_tel}</span></div>
                                    <div class="user-social-media d-xl-inline-block"><span class="mr-2  pinterest-color"> <i class="fas fa-mobile-alt"></i></span><span>{info.hot_mobile}</span></div>
                                    <div class="user-social-media d-xl-inline-block"><span class="mr-2 instagram-color"> <i class="fas fa-globe"></i></span><span>{info.hot_website}</span></div>
                                    <div class="user-social-media d-xl-inline-block"><span class="mr-2 youtube-color"> <i class="fas fa-envelope"></i></span><span>{info.hotel_email}</span></div>
                                    <div class="user-social-media d-xl-inline-block"><span class="mr-2  facebook-color"> <i class="fas fa-cart-plus"></i></span><span>{info.max_Goods}</span></div>
                                    <div class="user-social-media d-xl-inline-block"><span class="mr-2 medium-color"> <i class="fas fa-building"></i></span><span>{info.rooms}</span></div>
                                </div>
                                </Link>
                            </div>
                          )}
