...
export default class Month_Expiration extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    let datess_current = moment().add(30, 'days').unix()
    ...
    const exercise_current = {
      ...
      to: datess_current,
       ...
       axios.post('https://superadmins.herokuapp.com/admin/expired_in_a_month', exercise_current)
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                            <Link to="/Month_Expiration" class="nav-link active"><i class="fas fa-fw fa-chart-pie"></i>A month Before Expiration</Link>
                            </li>
                            <li class="nav-item ">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">A Month Before Expiration</h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">A Month Before Expiration</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
